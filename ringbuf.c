...
RingBufUsed(tRingBufObject *psRingBuf)
{
    ...
    //
    return ((ui32Write >= ui32Read) ? (ui32Write - ui32Read) : (psRingBuf->ui32Size - (ui32Read - ui32Write)));
}
...
RingBufContigUsed(tRingBufObject *psRingBuf)
{
    ...
    //
    return ((ui32Write >= ui32Read) ? (ui32Write - ui32Read) : (psRingBuf->ui32Size - ui32Read));
}
...
//
//*****************************************************************************
void RingBufAdvanceWrite(tRingBufObject *psRingBuf,
